...
public:
	 ...
	 */
	std::array<double, 16> pose(franka::Frame frame, const std::array<double, 7> &q,
	 ...
	 */
	std::array<double, 42> bodyJacobian(franka::Frame frame, const std::array<double, 7> &q,
	                                    const std::array<double, 16> &F_T_EE, // NOLINT(readability-identifier-naming)
	                                    const std::array<double, 16> &EE_T_K) // NOLINT(readability-identifier-naming)
	    const override;
	 ...
	 * @return Vectorized 6x7 Jacobian, column-major.
	 */
	std::array<double, 42> zeroJacobian(franka::Frame frame, const std::array<double, 7> &q,
	                                    const std::array<double, 16> &F_T_EE, // NOLINT(readability-identifier-naming)
	                                    const std::array<double, 16> &EE_T_K) // NOLINT(readability-identifier-naming)
	    const override;
	 ...
	 */
	std::array<double, 49>
	mass(const std::array<double, 7> &q, const std::array<double, 9> &I_total, // NOLINT(readability-identifier-naming)
	 ...
	 */
	std::array<double, 7> gravity(const std::array<double, 7> &q, double m_total,
	                              const std::array<double, 3> &F_x_Ctotal, // NOLINT(readability-identifier-naming)
	 ...
	 * added to this chain, so if you want to keep your original chain, make a copy before
	 */
	static void augmentFrame(const std::string &name, const std::array<double, 3> &center_of_mass, double mass,
