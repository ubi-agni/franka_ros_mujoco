...
{
protected:
	std::unique_ptr<franka_mujoco::ControllerVerifier> verifier;

	virtual void SetUp()
	{
		std::map<std::string, std::shared_ptr<franka_mujoco::Joint>> joint_map;
		for (int i = 1; i < 8; i++) {
		...
		verifier = std::make_unique<franka_mujoco::ControllerVerifier>(joint_map, "panda");
	}

	virtual void TearDown() {}
};
class ValidArmControllerTest : public ControllerVerifierFixture,
...
hardware_interface::ControllerInfo generate_arm_controller(const std::string &hw_interface, int num_joints = 7)
{
	hardware_interface::ControllerInfo controller;
...
hardware_interface::ControllerInfo generate_gripper_controller(const std::string &hw_interface, int num_joints = 2)
{
	hardware_interface::ControllerInfo controller;
	hardware_interface::InterfaceResources resource;
	resource.hardware_interface = hw_interface;
...
hardware_interface::ControllerInfo generate_arm_and_gripper_controller(const std::string &hw_interface)
{
	hardware_interface::ControllerInfo controller;
	hardware_interface::InterfaceResources resource;
	resource.hardware_interface = hw_interface;
...
INSTANTIATE_TEST_CASE_P(ValidArmControllerTest, // NOLINT(cert-err58-cpp)
                        ...
                        ::testing::Values(generate_arm_controller(effort), generate_arm_controller(position),
...
INSTANTIATE_TEST_CASE_P(NonClaimingArmControllerTest, // NOLINT(cert-err58-cpp)
                        ...
                        ::testing::Values(generate_arm_controller(""), generate_arm_controller(" "),
...
INSTANTIATE_TEST_CASE_P(MalformedArmControllerTest, // NOLINT(cert-err58-cpp)
                        ...
                        ::testing::Values(generate_arm_controller(effort, 6), generate_arm_controller(position, 8),
...
INSTANTIATE_TEST_CASE_P(ValidGripperControllerTest, // NOLINT(cert-err58-cpp)
                        ValidGripperControllerTest, ::testing::Values(generate_gripper_controller(effort)));

INSTANTIATE_TEST_CASE_P(NonClaimingGripperControllerTest, // NOLINT(cert-err58-cpp)
                        NonClaimingGripperControllerTest,
                        ::testing::Values(generate_gripper_controller(""), generate_gripper_controller(" "),
