...
void compareAffineTransformations(const Eigen::Affine3d &expected, const Eigen::Affine3d &actual, double tolerance)
{
	EXPECT_NEAR(Eigen::Vector3d(expected.translation())(0), Eigen::Vector3d(actual.translation())(0), tolerance);
	EXPECT_NEAR(Eigen::Vector3d(expected.translation())(1), Eigen::Vector3d(actual.translation())(1), tolerance);
	EXPECT_NEAR(Eigen::Vector3d(expected.translation())(2), Eigen::Vector3d(actual.translation())(2), tolerance);

	EXPECT_NEAR(Eigen::Quaterniond(expected.linear()).x(), Eigen::Quaterniond(actual.linear()).x(), tolerance);
	EXPECT_NEAR(Eigen::Quaterniond(expected.linear()).y(), Eigen::Quaterniond(actual.linear()).y(), tolerance);
	EXPECT_NEAR(Eigen::Quaterniond(expected.linear()).z(), Eigen::Quaterniond(actual.linear()).z(), tolerance);
	EXPECT_NEAR(Eigen::Quaterniond(expected.linear()).w(), Eigen::Quaterniond(actual.linear()).w(), tolerance);
}
