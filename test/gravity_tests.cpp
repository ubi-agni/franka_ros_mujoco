...
void compareVectorsElementWise(const Eigen::VectorXd &expected, const Eigen::VectorXd &actual, double tolerance)
{
	EXPECT_EQ(expected.size(), actual.size())
	    << "Cannot check element-wise equality, since vectors don't have same size";
